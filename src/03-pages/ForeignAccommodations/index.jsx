...
// 분리된 데이터 및 유틸리티 임포트
import {
  foreignDestinations as destinations,
  foreignCityCodeMap as cityCodeMap,
  foreignPopularDestinations as popularDestinations,
  foreignPopularRegions as popularRegions,
...
const ForeignAccommodations = () => {
  ...
  const handleSearch = () => {
    ...
    navigate(`/foreign/search/results?${params.toString()}`);
  };
    ...
    <div className={styles.mainClass}>
      ...
      {showSearchModal && (
        <SearchModal
          ...
          searchResultBasePath="/foreign/search/results"
        />
      )}
